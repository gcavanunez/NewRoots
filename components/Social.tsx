  ...
  return (
    <div className="px-6 lgg:px-0">
      ...
      <Script
        ...
        onLoad={() => {
          ...
          let feed = new Instafeed({
            ...
            template:
              '<a href="{{link}}"><img class="image" title="{{caption}}" src="{{image}}" /></a>',
          });
          feed.run();
      ...
      {/* <Script
        ...
        //* Error importing from the file system, next/node build tools are  dumb like that 
        ...
        onLoad={() => {
          ...
          let currentCount = 0;
          console.log(window.InstagramToken);
          let feed = new Instafeed({
            accessToken: window.InstagramToken,
            limit: 20,
            before: function () {
